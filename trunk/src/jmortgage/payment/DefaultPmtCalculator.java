/*
 *  @(#)DefaultPmtCalculator.java	1.0 2009/08/06
 *
 */
...
public final class DefaultPmtCalculator implements PmtCalculator {
     ...
     */
    public PmtCalculator setLoanAmt(double loanAmt) { return new DefaultPmtCalculator(this.interval, loanAmt, this.interestRate, this.years); }
     ...
     * @return <tt>PmtCalculator</tt> A new instance of <tt>DefaultPmtCalculator</tt>
     */
    public PmtCalculator setInterestRate(double interestRate) { return new DefaultPmtCalculator(this.interval, this.loanAmt, interestRate, this.years); }
     ...
     * @return <tt>PmtCalculator</tt> A new instance of <tt>DefaultPmtCalculator</tt>
     */
    public PmtCalculator setYears(int years) { return new DefaultPmtCalculator(this.interval, this.loanAmt, this.interestRate, years); }
     ...
     * @return <tt>PmtCalculator</tt> A new instance of <tt>DefaultPmtCalculator</tt>
     */
    public PmtCalculator setInterval(Interval interval) { return new DefaultPmtCalculator(interval, this.loanAmt, this.interestRate, this.years); }
