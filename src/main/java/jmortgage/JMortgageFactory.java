...
import jmortgage.pmi.PMICalculator;
import jmortgage.pmi.DefaultPMICalculator;
...
public class JMortgageFactory {
    ...
    /**
     * Builds an implementation of PMICalculator using reflection.
    ...
    public static PMICalculator getPMICalculator(Class instance, Class[] classes, Object[] args) {
        ...
        return((PMICalculator)InstantiateFactory.getInstance(
                instance, classes, args).create());
    }

    /**
     * Builds an implementation of PMICalculator using reflection using
     * its empty constructor if it has one.
     * @param instance  The class of the implementation of PMICalculator to
     * instantiate.
     * @return PMICalculator instantiation
   ...
   public static PMICalculator getPMICalculator(Class instance) {
    ...
    /**
     * Convenience method for creating a {@link DefaultPMICalculator}.
     * @param fivePctDivider the amount to divide the loan amount by if the
     * total percent of money down is less than 10 percent
     * @param tenPctDivider the amount to divide the loan amount by if the total
     * percent of money down is less than 15 percent and more than or equal to
     * 10 percent
     * @param fifteenPctDivider the amount to divide the loan amount by if the
     * total percent of money down is less than 20 percent and more than or
     * equal to 15 percent.
     * @return PMICalculator instantiation, in this case,
     * DefaultPMICalculator
     * @since 1.2
